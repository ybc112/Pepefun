...
const copy = {
  ...
  en: {
    ...
    home: {
      eyebrow: `${appName} Launch Arena`,
      title: 'Send your token into the PEPE arena',
      subtitle:
        'Create an independent ERC20 and mint vault, configure minting, taxes, rewards, and the receiver wallet. Every arena launch is written on-chain and appears in the project list after confirmation.',
      launch: 'Deploy token',
      openCommunity: 'Community',
      consoleAria: 'PEPE arena launch flow',
      consoleStats: [
        ['Arena', appSymbol, '100,000'],
        ['Mint', '300', '0.01 BNB'],
        ['Tax', '3 / 3', 'burn + holder rewards'],
        ['Mode', 'Mint', 'whitelist ready'],
      ],
      consoleFlow: ['Wallet', 'Factory', 'Token + Vault'],
      features: [
        ['01 Enter arena', 'Create contracts for 0.005 BNB', 'Wallets submit a real deployment transaction. The Factory is deployed, verified, and writes confirmed projects into the on-chain arena.'],
        ...
        ['03 Rules', 'Whitelist and taxes on-chain', 'Buy/sell taxes, rewards, burn, and whitelist mode are stored when the project is created. Opening and refunds follow the contract rules.'],
      ],
    },
    projects: {
      ...
      trade: 'Trade',
      website: 'Website',
      fallbackDescription: `${appName} PEPE launch project`,
      quota: (whitelistMinted: string, whitelistTotal: string, publicMinted: string, publicTotal: string) =>
...
function App() {
  ...
  useEffect(() => {
    ...
    localStorage.setItem('pepe-launch-language', language)
  }, [language])
...
function readLanguagePreference(): Language {
  const value = localStorage.getItem('pepe-launch-language')
